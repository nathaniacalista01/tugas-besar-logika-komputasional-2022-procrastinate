...
bayarProperty1 :- player1(ID,Loc,Money,ListCard),
                ...
                biayaSewa(Loc, 4, Price),
                Money < Price,
                checkAngelCard(ListCard, Result),
                (Result == 1 -> write('Apakah kamu ingin menggunakan Angel Card? (yes/no)'), nl,
                read(Answer), (Answer == ('yes') -> write('Kamu menggunakan Angel Card!'), remover('Angel Card', ListCard, NewList), 
                retract(player1(ID,Loc,Money,ListCard)), asserta(player1(ID,Loc,Money,NewList)); Answer == ('no') -> write('Yah kamu tidak menggunakan Angel Card'), 
                uangHabis));
                (Result == 0,
                 uangHabis).
...
bayarProperty2 :- player2(ID,Loc,Money,ListCard),
                ...
                (Result == 1 -> write('Apakah kamu ingin menggunakan Angel Card? (yes/no)'), nl,
                read(Answer), (Answer == ('yes') -> write('Kamu menggunakan Angel Card!'), remover('Angel Card', ListCard, NewList), 
                retract(player2(ID,Loc,Money,ListCard)), asserta(player2(ID,Loc,Money,NewList)); Answer == ('no') -> write('Yah kamu tidak menggunakan Angel Card'), 
                uangHabis));
                (Result == 0,
                 uangHabis).
