...
diceRandomizer(X,Y,Result1,Result2):- Temp1 is mod(5*Y-X+99,6), dice(Temp1,Angka1),write('Ini dadu 1 : '),write(Angka1),
                                    Result1 is Angka1,Temp2 is mod(2*Y - X+230,6),
                                    dice(Temp2,Angka2),write('ini angka 2 : '),write(Angka2),Result2 is Angka2.
...
throwDice1 :- 
                ...
                writeNormal(Dice1,Dice2),NewLoc is Dice1 + Dice2,updateLoc1(NewLoc),!),!.
...
throwDice2 :-
                ...
                writeNormal(Dice3,Dice4),NewLoc is Dice3 + Dice4,updateLoc2(NewLoc),!),!.
