...
diceRandomizer1(X,Y,Result1,Result2):- Temp1 is mod(2*13 - X+230,6), dice(Temp1,Angka1), Result1 is Angka1, 
                                    Temp2 is mod(5*12-X+99,6), dice(Temp2,Angka2),Result2 is Angka2.
...
diceRandomizer2(X,Y,Result1,Result2):- Temp1 is mod(2*13 - X+230,6), dice(Temp1,Angka1), Result1 is Angka1,
                                     Temp2 is mod(5*12- X +99,6), dice(Temp2,Angka2),Result2 is Angka2.
